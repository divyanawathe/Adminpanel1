...
if(isset($_POST['Submit'])) 
{ 
                    mysql_connect($id,$vendor_id,$name,$email,$phone_num,$city,$state,$qur_subject,$query,$page_no);
                    mysql_select_db(visuareal);
                    $sql= "SELECT * from Inqueries WHERE id='$id'";
                    ...
                    <div class="card-body">
                      <form action="#" method="POST" class="form-horizontal">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" name="vendor_id" value="<?php echo $row['vendor_id'];?>" required>
                          </div>
                        </div>
                        <div class="border-bottom my-5 border-gray-200"></div>
                        <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" id="register-email" type="email" name="registerEmail" value="<?php echo $row['email'];?>" required>
                          </div>
                        </div>
                         <div class="border-bottom my-5 border-gray-200"></div>
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="tel" id="phone" name="phone_num" pattern="[0-9]{10}" value="<?php echo $row['phone_num'];?>" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" name="qur_subject" value="<?php echo $row['qur_subject'];?>"required>
                          </div>
                        </div>
                        <div class="border-bottom my-5 border-gray-200"></div>
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" name="query" value="<?php echo $row['query'];?>" required>
                          </div>
                        </div>
                        <div class="border-bottom my-5 border-gray-200"></div>
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" name="page_no" value="<?php echo $row['page_no'];?>" required>
                          </div>
                        </div>
